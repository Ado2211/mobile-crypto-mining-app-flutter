                    ...
                    Expanded(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          const SizedBox(height: Dimensions.space5),
                          DefaultText(
                              text: "${MyConverter.getReturnPerDay(controller.purchasedPlanList[index].minReturnPerDay ?? "",controller.purchasedPlanList[index].maxReturnPerDay ?? "")} ${controller.purchasedPlanList[index].miner?.coinCode ?? ""}",
